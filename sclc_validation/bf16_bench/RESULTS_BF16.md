...
| bf16 | bf16 | `bf16` | overexpress | 300 | running |
...
|---|---|---|---|---|---|
| fp32 baseline (accuracy ref; includes one-time cache build) | 6671.61s (1.85h) | 63.523 | 117.723 | 84.0 | see per-unit markers (39.93 GiB at calibration) |
| fp32 repeat (**speed/energy ref**) | 4944.71s (1.37h) | 80.235 | 110.2056 | 84.0 | -- |
| bf16 | -- | -- | -- | -- | -- |

(Figures are from `runs/<tag>/power/<tag>.power.json`, generated by
`power_sample.sh`, not hand-typed.)

**Speedup = fp32_repeat wall time / bf16 wall time.** **Energy ratio =
bf16 Wh / fp32_repeat Wh.** Colleague-comparable headline: rho, top-20
overlap, speedup (vs fp32_repeat), Wh per arm.
